...
# Coworking Spaces
space1 = Workspace.create(name: 'SF Mid Market - Private Office 2p', model: 'PO-2p', description: 'San Francisco -Mid Market. Move-in ready office, capacity of 2 persons. Fully furnished.',
...
space2 = Workspace.create(name: 'SF Mid Market - Private Office 4p', model: 'PO-4p', description: 'San Francisco - Mid Market. Move-in ready office, capacity of 4 people. Fully furnished.',
...
space3 = Workspace.create(name: 'SF Downtown - Meeting Room 20p', model: 'MR-20p', description: 'San Francisco - Downtown. Book a room by the hour for meeting clients and co-workers. Capacity of 20 people.',
...
space4 = Workspace.create(name: 'Dallas Downtown - Meeting Room 10p', model: 'MR-10p', description: 'Dallas - Downtown. Book a room by the hour for meeting clients and co-workers. Capacity of 10 people.',
...
space5 = Workspace.create(name: 'Dallas Downtown - Private Office 4p', model: 'PO-4p', description: 'Dallas - Downtown. Move-in ready office, capacity of 4 people. Fully furnished.',
...
space6 = Workspace.create(name: 'NY Central Park - Private Office 4p', model: 'PO-4p', description: 'New York City - Central Park - Manhattan. Move-in ready office, capacity of 4 persons. Fully furnished.',
...
space7 = Workspace.create(name: 'NY Central Park - Private Office 8p', model: 'PO-8p', description: 'New York City - Central Park - Manhattan. Move-in ready office, capacity of 8 persons. Fully furnished.',
...
reservation1 = Reservation.create(user_id: user1.id, workspace_id: space1.id, date_reserved: Date.today, date_cancelled: '', start_date: start_date1, end_date: end_date1,
...
reservation2 = Reservation.create(user_id: user2.id, workspace_id: space4.id, date_reserved: Date.today, date_cancelled: '', start_date: start_date2, end_date: end_date2,
